const menuData = [
{
    ...
    subSections: [
    {
        ...
        subSubSections: [
        ["Дерево отрезков с суммами", "Tree-of-segments-with-sums"],
        ["Дерево отрезков с минимальными/максимальными значениями", "Tree-of-segments-with-minmax"],
        ["Дерево отрезков с добавлением модификаторов (range update)", "Tree-of-segments-with-updates"],
        ],
    },
    {
    ...
    },
    {
        ...
        subSubSections: [
        ["Подсекция 1", "Simple-Segment-Tree-1"],
        ],
    },
    ],
},
